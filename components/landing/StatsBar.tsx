const ESTATISTICAS = [
  { numero: "347", rotulo: "itens circulando" },
  { numero: "112", rotulo: "doações" },
  { numero: "580", rotulo: "alunos" },
  { numero: "R$ 21 mil", rotulo: "economizados" },
];
      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-10 gap-y-2">
        {ESTATISTICAS.map((e, i) => (
          <p key={e.rotulo} className={i > 0 ? "border-l border-[#EDF1F8] pl-10" : ""}>
            <span className="font-[family-name:var(--font-sora)] font-bold text-[#071C3D]">
              {e.numero}
            </span>{" "}
